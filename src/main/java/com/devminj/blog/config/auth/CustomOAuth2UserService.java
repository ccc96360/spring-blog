...
import com.devminj.blog.config.auth.dto.OAuthAttributes;
import com.devminj.blog.config.auth.dto.SessionUser;
import com.devminj.blog.domain.user.User;
import com.devminj.blog.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private User saveOrUpdate(OAuthAttributes attributes){
        User user = userRepository.findBySiteId(attributes.getSiteId())
